...
import { PRISMIC_ENDPOINT, PRISMIC_KEY } from '../constants/common';

/* tslint:disable */

export const PrismicClient = (req: any = null) =>
  Prismic.client(PRISMIC_ENDPOINT, createClientOptions(req, PRISMIC_KEY));
