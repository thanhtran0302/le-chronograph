...
import { Layout } from './LegalNotice.styles';

const LegalNotice: FC = () => (
  <Layout>
    <strong>
      La seule contrepartie à l'utilisation de ces mentions légales, est
      l'engagement total à laisser le lien crédit subdelirium sur cette page de
      mentions légales.
    </strong>
    <br />
    <br />
    ...
    <p>
      ...
      site
      <a href="http://https://www.lechronograph.com/">
    ...
    <p>
      <strong>Propriétaire</strong> : Le Chronograph – Le Chronograph – 5 rue
      félix chobert
      <br />
    ...
    <p>
      ...
      décidée par Le Chronograph, qui s’efforcera alors de communiquer
    ...
    <p>
      ...
      est mis à jour régulièrement par Thanh Tran. De la même façon, les
    ...
    <p>
      Le Chronograph s’efforce de fournir sur le site
      <a href="http://https://www.lechronograph.com/">
        https://www.lechronograph.com
      </a>
      des informations aussi précises que possible. Toutefois, il ne pourra être
      tenue responsable des omissions, des inexactitudes et des carences dans la
    ...
    <p>
      Le Chronograph est propriétaire des droits de propriété intellectuelle ou
    ...
    <p>
      ...
      procédé utilisé, est interdite, sauf autorisation écrite préalable de : Le
      Chronograph.
    </p>
    <p>
    ...
    <p>
      Le Chronograph ne pourra être tenue responsable des dommages directs et
      indirects causés au matériel de l’utilisateur, lors de l’accès au site
      https://www.lechronograph.com, et résultant soit de l’utilisation d’un
      matériel ne répondant pas aux spécifications indiquées au point 4, soit de
      l’apparition d’un bug ou d’une incompatibilité.
    </p>
    <p>
      Le Chronograph ne pourra également être tenue responsable des dommages
    ...
    <p>
      ...
      contact) sont à la disposition des utilisateurs. Le Chronograph se réserve
      ...
      cas échéant, Le Chronograph se réserve également la possibilité de mettre
      en cause la responsabilité civile et/ou pénale de l’utilisateur, notamment
    ...
    <p>
      En tout état de cause Le Chronograph ne collecte des informations
    ...
    <p>
      ...
      de Le Chronograph et de ses droits permettrait la transmission des dites
    ...
    <p>
      ...
      en place avec l’autorisation de Le Chronograph. Cependant, Le Chronograph
    ...
    <p>
      ...
      de l’utilisateur. Un cookie est un fichier de petite taille, qui ne permet
